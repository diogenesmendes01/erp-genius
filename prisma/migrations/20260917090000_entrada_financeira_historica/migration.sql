...
BEGIN
 ...
 SELECT linha_fonte.*,lo.origem AS lote_origem INTO l FROM "LinhaPreparacaoMigracao" linha_fonte JOIN "LotePreparacaoMigracao" lo ON lo.id=linha_fonte."loteId" WHERE linha_fonte.id=NEW."linhaId";
