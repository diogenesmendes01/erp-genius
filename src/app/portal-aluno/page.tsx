...
export default async function InicioPortalAlunoPage() {
  const [sessao, reposicoes, preferencia] = await Promise.all([exigirSessaoPortalAluno(), listarReposicoesDoPortalAluno(), consultarPreferenciaFusoPortalAluno()]);
