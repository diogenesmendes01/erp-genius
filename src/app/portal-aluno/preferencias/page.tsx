...
export default async function PreferenciasPortalAlunoPage() {
  ...
  return <section className="mx-auto max-w-3xl p-6 sm:p-10"><VoltarPara href="/portal-aluno" /><h1 className="mt-4 text-2xl font-medium">Preferências de horário</h1><PreferenciasFusoPortalFormulario atual={preferencia.fusoExibicao} /></section>;
}
