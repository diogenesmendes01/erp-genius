  ...
  return <div className="space-y-5">
    ...
    {dados.podePropor ? <form className="space-y-4 rounded border bg-[var(--surface)] p-4" onSubmit={(evento) => { evento.preventDefault(); enviarProposta(); }}>
      ...
      <fieldset disabled={ocupado} className="space-y-4">
        ...
        <button type="submit" disabled={ocupado || !houveAlteracao || !!proposta} className="rounded bg-brand-solid px-4 py-2 text-white disabled:opacity-50">{ocupado ? "Registrando…" : "Registrar proposta de correção"}</button>
      </fieldset>
