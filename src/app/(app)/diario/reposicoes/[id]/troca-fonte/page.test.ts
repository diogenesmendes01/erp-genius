...
it("consulta somente a reposição contextual depois do guard de gestão", async () => {
  ...
  mocks.consultar.mockResolvedValue({
    contexto: { reposicaoId: "repo/1?", materialId: "material", matriculaId: "matricula", fonteMaterialAtual: { versao: 1, revisao: "material-r1" }, fontePublicacaoAtual: { versao: 2, revisao: "aula-r2" }, materialDisponivel: true, disponibilizacaoId: null },
