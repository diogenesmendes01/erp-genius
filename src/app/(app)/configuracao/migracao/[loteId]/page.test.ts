...
vi.mock("@/server/migracao/consultas", () => ({ consultarLotePreparacaoMigracao: vi.fn().mockResolvedValue({ ok: true, dado: {
  ...
  linhas: [{ id: "linha-1", linhaOrigem: "alunos!2", alunoOrigemId: "a-1", turmaOrigemId: null, matriculaOrigemId: null, financeiroOrigemId: null, entradaHash: "hash-original", dadosOrigem: { aluno: { email: "ana@example.test" } }, estado: "COM_PENDENCIAS", aplicacoesCadastro: [{ situacao: "APLICADO", alunoId: "destino-1", detalhe: "Cadastro criado", criadoEm: new Date(), executadoPor: { nome: "Admin" } }], pendencias: [{ campo: "aluno.email", codigo: "EMAIL_INVALIDO", detalhe: "E-mail inválido." }], colisoes: [{ tipo: "ALUNO", identificadorOrigem: "a-1", outraLinhaOrigem: "alunos!3" }] }],
} }) }));
