...
it("exibe instantes administrativos no fuso preferido sem converter datas de entrada", () => {
  const html = renderToStaticMarkup(createElement(FichaLead, {
    ...
    timeline: [{ id: "evento", tipo: "DatasAtualizadas", payload: { proximoFollowUp: "2026-01-10T15:00:00.000Z", proximoFollowUpCivil: "2026-01-10", dataExperimental: "2026-01-02T10:30:00.000Z", dataProposta: "2026-01-11T15:00:00.000Z", dataPropostaCivil: "2026-01-11" }, criadoEm: "2026-01-01T02:30:00.000Z", autor: { nome: "Secretaria" } }],
...
it("recorre a UTC sem alterar o datetime-local", () => {
...
it("preserva literais e eventos antigos sem converter nem fabricar referência civil", () => {
  const lead = { id: "lead", codigo: "L-1", nome: "Ana", telefoneE164: null, etapa: EtapaLead.NOVO, segmento: Segmento.ADULTO, temperatura: Temperatura.MORNO, b2b: false, criadoEm: "2026-01-01T02:30:00.000Z", pais: null, vendedor: null, origemCampanha: null, origemAnuncio: null, interesse: null, objetivo: null, urgencia: null, orcamento: null, objecao: null, proximaAcao: null, proximoFollowUp: "2026-01-10", dataExperimental: "2026-01-02T10:30:00.000Z", dataProposta: "2026-01-11", motivoPerda: null, matricula: null, valorPrevisto: null, planoPrevisto: null, comissaoPrevista: null, documentos: [], professorExperimentalId: null };
  const html = renderToStaticMarkup(createElement(FichaLead, { lead, timeline: [{ id: "evento", tipo: "DatasAtualizadas", payload: { proximoFollowUp: "2026-01-10T15:00:00.000Z", dataExperimental: "2026-01-02", dataProposta: "legado-inválido" }, criadoEm: lead.criadoEm, autor: null }], professores: [], preferenciaFusoExibicao: "America/Costa_Rica" }));
  expect(html).toContain("Follow-up: 2026-01-10T15:00:00.000Z (registro histórico sem referência civil)");
  expect(html).toContain("Experimental: 2026-01-02");
