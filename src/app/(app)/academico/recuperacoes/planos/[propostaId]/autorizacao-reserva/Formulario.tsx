...
export function AutorizarReservaEspecial({ propostaId, habilidades }: { propostaId: string; habilidades: string[] }) {
  ...
  return <form className="space-y-3 rounded border p-4" onSubmit={evento => {
    ...
    <fieldset disabled={ocupado} className="space-y-3">
      ...
      <label className="block" htmlFor="fuso">Fuso do prazo<input id="fuso" name="fuso" list="fusos-autorizacao-reserva" defaultValue="UTC" required maxLength={100} className="block rounded border p-2" /></label>
      <datalist id="fusos-autorizacao-reserva"><option value="America/Sao_Paulo" /><option value="America/Costa_Rica" /><option value="UTC" /></datalist>
