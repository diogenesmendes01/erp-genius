...
export default async function NovaGradePage({ searchParams }: { searchParams: Promise<{ busca?: string; cursor?: string; turmaId?: string | string[] }> }) {
  ...
  if (Array.isArray(q.turmaId)) return <div className="space-y-4"><Link href="/academico/grades/nova" className="underline">Voltar à preparação de grades</Link><p role="alert">Seleção de turma inválida.</p></div>;
