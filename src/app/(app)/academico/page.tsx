...
export default async function AcademicoPage({ searchParams }: { searchParams: Promise<{ historico?: string; antesDe?: string }> }) {
  ...
  const resultado = await listarSolicitacoesAcademicas({ apenasAbertas: !todas, antesDe: filtros.antesDe });
  ...
  return <div className="space-y-5">
    ...
    <MudancasAcademicasPainel solicitacoes={dados?.solicitacoes ?? []} erroConsulta={resultado.ok ? null : resultado.erro} />
