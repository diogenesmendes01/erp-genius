...
export default async function ExcecaoAdmissaoPage({ params, searchParams }: { params: Promise<{ reservaId: string }>; searchParams: Promise<{ pagina?: string }> }) {
  ...
  const d = r.dado;
  return <div className="space-y-4"><Link className="underline" href="/academico/admissoes">Voltar às admissões</Link><h1 className="text-2xl">Exceção de ingresso após o limite</h1>
