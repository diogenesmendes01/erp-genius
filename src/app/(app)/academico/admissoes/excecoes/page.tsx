...
export default async function ExcecoesPage({ searchParams }: { searchParams: Promise<{ pagina?: string }> }) {
  ...
  return <div className="space-y-4"><Link className="underline" href="/academico/admissoes">Voltar às admissões</Link><h1 className="text-2xl">Exceções de ingresso por reserva</h1>
