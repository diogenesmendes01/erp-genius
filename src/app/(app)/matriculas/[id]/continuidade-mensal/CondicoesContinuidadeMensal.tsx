        ...
        <fieldset className="space-y-2 rounded border p-3">
          ...
          {ajusteVencimento === "PROXIMO_DIA_UTIL" && <div className="space-y-3 rounded border p-3">
            ...
            <div className="grid gap-3 md:grid-cols-2">
              ...
              <label className="block" htmlFor="calendario-inicio">Início da vigência<input id="calendario-inicio" className={classe} name="calendarioInicioVigencia" type="date" required /></label>
              <label className="block" htmlFor="calendario-fim">Fim da vigência<input id="calendario-fim" className={classe} name="calendarioFimVigencia" type="date" required /></label>
            </div>
