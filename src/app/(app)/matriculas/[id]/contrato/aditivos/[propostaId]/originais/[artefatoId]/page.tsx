...
type Processo = { fornecedor: string; ambiente: string; estado: string; tentativaAtual: number; referenciaExterna: string | null; criadoEm: Date; paginaTentativas: number; temMaisTentativas: boolean; tentativas: { numero: number; iniciadaEm: Date; temMaisObservacoes: boolean; observacoes: { resultado: string; referenciaExterna: string | null; observadaEm: Date }[] }[] };
