...
type Contexto = { matriculaId: string; identificacaoMatricula: string; status: string; aluno: string; moeda: string; cobrancas: { id: string; codigo: string | null; tipo: string; vencimento: string; saldo: number }[]; pagadores: { id: string; rotulo: string }[] };
