...
export default async function AcertosTaxaPage({ searchParams }: { searchParams: Promise<{ pagina?: string }> }) {
  ...
  return <main className="space-y-4"><Link href="/financeiro" className="underline">Voltar ao Financeiro</Link><h1 className="text-2xl">Acertos de taxa por aditivo</h1>
