...
export default async function AcertosCoberturaPage({ searchParams }: { searchParams: Promise<{ pagina?: string }> }) {
  ...
  return <main className="space-y-4"><VoltarPara href="/financeiro" para="Financeiro" /><h1 className="text-2xl">Correções de cobertura por aditivo</h1><p>Prepare todas as mensalidades, registre a decisão independente e aplique o conjunto completo uma única vez.</p>
