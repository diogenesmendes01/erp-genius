...
export default async function AcertoCoberturaDetalhe({ params }: { params: Promise<{ matriculaId: string; propostaId: string }> }) {
  ...
  return <main className="space-y-5"><VoltarPara href="/financeiro/acertos-cobertura" para="Correções de cobertura" /><h1 className="text-2xl">Correção de cobertura · matrícula {d.matriculaId}</h1>
