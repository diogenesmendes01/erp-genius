...
export function ImpactosCoberturaFormulario({ matriculaId, propostaId, conclusaoId, revisaoHash, cobrancas }: { matriculaId: string; propostaId: string; conclusaoId: string; revisaoHash: string; cobrancas: Cobranca[] }) {
