...
export function ConferenciaFinanceiraMigracao({ dados, preferenciaFusoExibicao = null }: { dados: DadosConciliacaoFinanceira; preferenciaFusoExibicao?: string | null }) {
  ...
  if (!dados.linha.mapa) return <section className="rounded border border-amber-200 bg-amber-50 p-4 text-sm"><h2 className="font-medium">Conciliação financeira migrada</h2><p role="alert">Esta linha ainda não possui vínculo M01 para uma matrícula. A conciliação não pode ser preparada.</p></section>;
