...
type Recebimento = { id: string; cobrancaId: string | null; valor: string; moeda: string; forma: string; dataPagamento: string; chaveIdempotencia: string; hashDados: string | null; autorId: string };
