...
it("submete confirmação, proposta e decisão com os destinos explícitos", async () => {
  preparar();
  dados({ periodoInicio: "2026-09-01", periodoFim: "2026-09-30", quantidadeComprovada: "2", referenciaServico: "SET-2", evidencia: "diário", cobrancaId: "cobranca", valor: "100", aprovar: "sim", motivo: "Condições conferidas" });
