...
const PENDENTES = new Set<string>([
  ...
  "src/app/(app)/configuracao/catalogo/IdiomasPainel.tsx",
  "src/app/(app)/configuracao/catalogo/ModalidadeFormulario.tsx",
  "src/app/(app)/configuracao/catalogo/NiveisPainel.tsx",
  "src/app/(app)/configuracao/catalogo/PrecosPainel.tsx",
  "src/app/(app)/configuracao/catalogo/ProdutosPainel.tsx",
  "src/app/(app)/configuracao/migracao/PreparacaoMigracaoPainel.tsx",
  ...
  "src/app/(app)/configuracao/turmas/TurmaFormulario.tsx",
  "src/app/(app)/configuracao/usuarios/UsuarioFormulario.tsx",
  "src/app/(app)/configuracao/usuarios/UsuariosPainel.tsx",
  "src/app/(app)/configuracao/whatsapp/AvisosAgendaPainel.tsx",
  "src/app/(app)/configuracao/whatsapp/ComercialPainel.tsx",
  "src/app/(app)/configuracao/whatsapp/NumerosPainel.tsx",
  "src/app/(app)/configuracao/whatsapp/PoliticaPainel.tsx",
