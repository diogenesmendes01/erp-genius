...
async function inserirMapas(ativa = true) {
  await prisma.$executeRaw`INSERT INTO "CorrespondenciaProdutoMigracao" (id,origem,"produtoOrigemId",versao,"produtoId","paisId",moeda,ativa,"revisadaPorId") VALUES ('produto-v1',${origem},'oferta-legada',1,${produtoId},${paisId},'BRL',${ativa},${adminId})`;
...
it("não ressuscita a versão revogada e preserva novo ensaio ao mudar o contexto", async () => {
  ...
  await prisma.$executeRaw`INSERT INTO "CorrespondenciaProdutoMigracao" (id,origem,"produtoOrigemId",versao,"produtoId","paisId",moeda,ativa,"revisadaPorId") VALUES ('produto-v2',${origem},'oferta-legada',2,${produtoId},${paisId},'BRL',false,${adminId})`;
