...
export async function consultarPermutas() {
  return executarAcao(async () => {
    ...
    return prisma.$transaction(async tx => {
      ...
      if (!usuario.ativo || (!podeFinanceiro && !usuario.papeis.includes(Papel.GERENTE_PEDAGOGICO))) throw new ErroPermissao();
