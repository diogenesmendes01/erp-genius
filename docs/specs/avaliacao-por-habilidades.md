...
| AV-27 | Q145: responsáveis autorizados recebem informações acadêmicas pela equipe, identificados pela matrícula e autorização vigente escolhidas explicitamente; não incluir área autenticada de responsáveis nesta entrega. Portal acadêmico permanece do aluno. Ser pagador não concede acesso acadêmico automaticamente. Revogação, mudança de vínculo ou contexto legado sem matrícula impedem novo envio e mantêm somente o histórico em leitura/conferência. |
