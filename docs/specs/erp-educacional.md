...
B02/Q69 — devolução de crédito integrada, com aceite final pendente (17/09/2026): pedido/evidência/destino compõem proposta financeira; outra pessoa autorizada aprova e reserva o saldo. A capacidade específica de execução pode ser concedida pela Administração. Execução manual registra referência e evidência, sem fabricar recebimento. Resultado incerto conserva a reserva até conciliação; cancelamento antes da execução libera apenas sua reserva. Uso Q68 e devolução Q69 disputam o mesmo saldo com serialização. Migrações 207/209 em DEV2 e integração. Testes financeiros dirigidos aprovados; callbacks completos e validação independente do conjunto ainda pendentes. Q87, recebimento original com múltiplas destinações ou antecipação sem destino, continua uma entrega distinta não concluída. Evidências e commits no [quadro único](../planejamento/quadro-entregas.md).
