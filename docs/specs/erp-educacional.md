...
Decisão do usuário em 18/09/2026: permitir corrigir, por aditivo, o período de cobertura de mensalidade inclusive já iniciado ou pago. Exigir justificativa, evidências e acerto financeiro independente de todos os impactos: Financeiro prepara e outra pessoa autorizada aprova antes de aplicar. Preservar recebimentos, cobertura original e histórico; assinatura isolada não modifica a cobrança. A referência dos próximos períodos segue Q169. Implementação local parcial: conjunto financeiro completo, aprovação independente, aplicação atômica, preservação dos limites originais e consulta/tela restritas a Financeiro/Administração. Migrações238/240 vinculam o conjunto ao intervalo assinado e recusam sobreposição ou lacuna nova nos efeitos; impactos colaterais são explicitamente classificados e aprovados. Testes dirigidos e revisão SQL independente da240 aprovados. Consumidor de continuidade integrado com emissão real nas opções preservar/mudar referência e replay sem duplicação; cadeia de múltiplos aditivos após recomposição implementada e testada em unidade. Revisão independente e homologação visual local aprovadas; resta o ensaio integrado da combinação recomposição/aditivos. Não representa conclusão do fluxo.
