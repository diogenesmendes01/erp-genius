...
Estado local Q165 em18/09/2026: fonte contratual pré-aceite, cálculo/aplicação, condições, reapresentação e reconferência integrados. Correção255 em896c5564 conserva fotografia posterior completa e impede reconferência artificial sem mudança, com recuperação por nova aprovação quando a alçada perde validade. Principal:36/36 integrações de acerto/delta/efetivação,20/20 consulta/página e TypeScript saída0. TESTER:22/22 integrações independentes e revisão aprovada. Homologação visual confirmou preparo, decisões, aplicação, bloqueio sem fato novo e oferta de nova preparação após crédito posterior, preservando histórico. A fixture não percorreu criação de novo crédito delta nem ajuste material de cobrança; esses ramos não recebem aceite por inferência. Cancelamento externo autenticado aguarda Q155; destino da permuta aguarda Q171. Evidências detalhadas no quadro único e na SPEC de desistência. Não equivale ao aceite integral.
