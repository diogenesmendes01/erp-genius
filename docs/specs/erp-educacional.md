...
Os incrementos [612](../planejamento/validacao-incremento-612.md) e [613](../planejamento/validacao-incremento-613.md) implementam adaptadores de revisão fixa do Drive e credenciais separadas de publicação. Ainda não estão integrados ao fluxo persistido de publicação/reprodução. A revisão [614](../planejamento/validacao-incremento-614.md) identificou que o rascunho de migração 146 não pode ser aplicado sem resolver a cadeia de fontes substitutas; o requisito permanece parcial.
