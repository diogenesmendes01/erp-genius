...
CREATE UNIQUE INDEX "PropostaRegraBeneficioReposicaoOferta_autorId_chaveIdempotencia_key" ON "PropostaRegraBeneficioReposicaoOferta"("autorId","chaveIdempotencia");
...
CREATE UNIQUE INDEX "BeneficioReposicaoParticularMatricula_aplicadoPorId_chaveIdempotencia_key" ON "BeneficioReposicaoParticularMatricula"("aplicadoPorId", "chaveIdempotencia");
CREATE UNIQUE INDEX "BeneficioReposicaoParticularMatricula_matriculaId_vigenteAPartirDe_key" ON "BeneficioReposicaoParticularMatricula"("matriculaId", "vigenteAPartirDe");
CREATE INDEX "BeneficioReposicaoParticularMatricula_matriculaId_vigenteAPartirDe_idx" ON "BeneficioReposicaoParticularMatricula"("matriculaId", "vigenteAPartirDe");
...
CREATE UNIQUE INDEX "EncontroAgenda_reposicaoIndividualId_key" ON "EncontroAgenda"("reposicaoIndividualId") WHERE "reposicaoIndividualId" IS NOT NULL;
...
CREATE UNIQUE INDEX "ExcecaoAgendaReposicaoIndividual_solicitanteId_chaveIdempotencia_key" ON "ExcecaoAgendaReposicaoIndividual"("solicitanteId", "chaveIdempotencia");
...
CREATE UNIQUE INDEX "AutorizacaoExcecaoReposicaoParticular_solicitanteId_chaveIdempotencia_key" ON "AutorizacaoExcecaoReposicaoParticular"("solicitanteId","chaveIdempotencia");
...
CREATE INDEX "AgendaReposicaoIndividual_beneficioId_periodoInicio_periodoFimExclusivo_statusBeneficio_idx" ON "AgendaReposicaoIndividual"("beneficioId", "periodoInicio", "periodoFimExclusivo", "statusBeneficio");
